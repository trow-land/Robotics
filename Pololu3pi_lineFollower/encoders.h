...
ISR( INT6_vect ) {
  ...
  // State:  new B   new A   old B   old A
    state_eRight = state_eRight | ( e0_B  << 3 );
    state_eRight = state_eRight | ( e0_A  << 2 );

    // Handle which transition we have registered.
    // Complete this if statement as necessary.
    // Refer to the labsheet. 
    if( state_eRight == 0 ) {          // no change
    
    } else if( state_eRight == 1 ) {
        count_eRight = count_eRight - 1;   // forwards

    } else if( state_eRight == 2 ) {

        count_eRight = count_eRight +1;   // backwards

    } else if( state_eRight == 3 ) { // no change
    ...
    } else if( state_eRight == 5 ) { // no change
     

    } else if( state_eRight == 6 ) {  // no change
    ...
    } else if( state_eRight == 9 ) {  // no change
    
    } else if( state_eRight == 10 ) {  // no change
    
    } else if( state_eRight == 11 ) {

        count_eRight = count_eRight +1;   // backwards

    } else if( state_eRight == 12 ) {  // no change
    ...
    } else if( state_eRight == 15 ) {  // no change
...
ISR( PCINT0_vect ) {
    ...
    state_eLeft = state_eLeft | ( e1_B  << 3 );
    state_eLeft = state_eLeft | ( e1_A  << 2 );


    // Handle which transition we have registered.
    // Complete this if statement as necessary.
    // Refer to the labsheet. 
 if( state_eLeft == 0 ) {          // no change
    
    } else if( state_eLeft == 1 ) {
        count_eLeft = count_eLeft - 1;  // forwards

    } else if( state_eLeft == 2 ) {
      
        count_eLeft = count_eLeft +1;   // backwards

    } else if( state_eLeft == 3 ) { // no change
    ...
    } else if( state_eLeft == 5 ) { // no change
     

    } else if( state_eLeft == 6 ) {  // no change
    ...
    } else if( state_eLeft == 9 ) {  // no change
    
    } else if( state_eLeft == 10 ) {  // no change
    
    } else if( state_eLeft == 11 ) {

        count_eLeft = count_eLeft +1;   // backwards

    } else if( state_eLeft == 12 ) {  // no change
    ...
    } else if( state_eLeft == 15 ) {  // no change
...
void setupEncoder0() 
{
    ...
    state_eRight = state_eRight | ( e0_B << 1 );
    state_eRight = state_eRight | ( e0_A << 0 );
...
void setupEncoder1() 
{
    ...
    // Shift values into correct place in state.
    // Bits 1 and 0  are prior states.
    state_eLeft = state_eLeft | ( e1_B << 1 );
    state_eLeft = state_eLeft | ( e1_A << 0 );
